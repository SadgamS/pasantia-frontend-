...
import { Breadcrumbs } from "pasantia/components/Breadcrumbs/Breadcrumbs";
import NotificationItem from "pasantia/components/Items/NotificationItem/NotificationItem";
...
import {
  ...
  navbarIconButton,
  navbarMobileMenu,
} from "pasantia/components/Navbars/DashboardNavbar/styles";
...
export const DashboardNavbar = ({ absolute, light, isMini }) => {
  ...
  const renderMenu = () => (
    <Menu
      ...
      sx={{ mt: 2 }}
    >
      <NotificationItem icon={<Icon>person</Icon>} title="Cuenta" />
      <NotificationItem icon={<Icon>logout</Icon>} title="Cerrar Sesion" />
    </Menu>
  );
